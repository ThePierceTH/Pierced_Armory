...
public class MidasShoulderGuardModel<T extends LivingEntity> extends AgeableListModel<T> {

    public static final ModelLayerLocation MIDAS_SHOULDER_GUARD = new ModelLayerLocation(new ResourceLocation(Constants.MOD_ID, "midas_shoulder_guard"), "main");
    public final ModelPart main;

    public MidasShoulderGuardModel(ModelPart root) {
