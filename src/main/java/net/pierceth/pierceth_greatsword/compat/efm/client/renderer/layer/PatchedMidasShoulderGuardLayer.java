package net.pierceth.pierceth_greatsword.compat.efm.client.renderer.layer;
...
public class PatchedMidasShoulderGuardLayer<E extends LivingEntity, T extends LivingEntityPatch<E>, M extends HumanoidModel<E>, AM extends HumanoidMesh> extends PatchedLayer<E, T, M, MidasShoulderGuardLayer<E, M>, AM> {

    public PatchedMidasShoulderGuardLayer() {
        super(null);
    }
