...
public class WeaponCapabilityPresets {
    ...
    public static final Function<Item, CapabilityItem.Builder> BAHAMUT = (item) -> {
            VOSWeaponCapability.Builder builder = VOSWeaponCapability.builder()
                ...
                .newStyleCombo(Styles.TWO_HAND,
                        ...
                        PierceTHAnimations.BAHAMUT_LAUTO2,
                        PierceTHAnimations.BAHAMUT_RAUTO1,
                        PierceTHAnimations.BAHAMUT_RAUTO2,
                        PierceTHAnimations.BAHAMUT_BAUTO1,
                        PierceTHAnimations.BAHAMUT_BAUTO2,
    ...
    @SubscribeEvent
    public static void register(WeaponCapabilityPresetRegistryEvent PierceWeapons) {
        PierceWeapons.getTypeEntry().put(new ResourceLocation(EpicFightMod.MODID,"greatsword"), GREATSWORD);
        PierceWeapons.getTypeEntry().put(new ResourceLocation(PiercethGreatsword.MODID,"ponguard"), PONGUARD);
        PierceWeapons.getTypeEntry().put(new ResourceLocation(PiercethGreatsword.MODID,"midas"), MIDAS);
        PierceWeapons.getTypeEntry().put(new ResourceLocation(PiercethGreatsword.MODID,"bahamut"), BAHAMUT);
        PierceWeapons.getTypeEntry().put(new ResourceLocation(PiercethGreatsword.MODID,"carver"), CARVER);
        }
    }
