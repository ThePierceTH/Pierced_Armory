...
public class MidasShoulderGuardTwoModel<T extends LivingEntity> extends AgeableListModel<T> {
	...
	public static final ModelLayerLocation MIDAS_SHOULDER_GUARD =
			new ModelLayerLocation(new ResourceLocation(PiercethGreatsword.MODID, "midas_shoulder_guard"), "main");
